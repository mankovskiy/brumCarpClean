...
export const WA_MESSAGE =
  "Hi, I would like a quote for carpet or upholstery cleaning. I can send photos.";
...
export const META_TITLE =
  "FreshLine Cleaning | Carpet & Upholstery Cleaning in Birmingham";
export const META_DESCRIPTION =
  "Professional carpet and upholstery cleaning across Birmingham and the West Midlands. Carpets, sofas, mattresses, stairs and end-of-tenancy cleans. Pet & child-safe products. Quick WhatsApp quotes.";
...
export const SERVICES = [
  {
    ...
    description:
      "Hot-water extraction deep cleaning for all carpet types. Removes embedded dirt, allergens and tough stains.",
  ...
  },
  {
    ...
    description:
      "Specialist cleaning for sofas, armchairs and fabric furniture. Safe across all upholstery types.",
  ...
  },
  {
    ...
    description:
      "Hygienic deep-clean to remove dust mites, stains and odours. For a healthier night's sleep.",
  ...
  },
  {
    ...
    description:
      "Specialist stair attachments tackle heavy-traffic areas and tight spaces other cleaners miss.",
  ...
  },
  {
    ...
    description:
      "Professional end-of-tenancy carpet cleaning to meet letting agency standards and protect your deposit.",
  ...
  },
  {
    ...
    description:
      "Enzyme-based treatment that neutralises pet urine odours and stains at the source — not just the surface.",
...
export const PROCESS_STEPS = [
  {
    ...
    description:
      "Take a few photos of the areas you want cleaned and send them to us. This lets us give you an accurate, fair quote.",
  },
  {
    title: "Receive a Clear Quote",
    description:
      "We review your photos and come back quickly with a transparent price. No hidden extras, no pressure.",
  },
  {
    title: "We Clean at Your Home",
    description:
      "We arrive on time with all our own professional equipment and take care of everything.",
  },
  {
    title: "Enjoy Fresh Results",
    description:
      "Carpets are dry within a few hours. Then just enjoy a noticeably cleaner, fresher home.",
  },
];
...
export const WHY_US = {
  ...
  imageAlt:
    "Professional cleaning technician using hot-water extraction equipment on a carpet",
  features: [
    {
      title: "Professional Equipment",
      description:
        "Powerful hot-water extraction machines — the industry gold standard for deep, thorough results.",
    },
    {
      title: "Careful Stain Treatment",
      description:
        "Every stain is pre-treated with appropriate solutions before the main clean.",
    },
    {
      title: "Clear, Honest Pricing",
      description:
        "No hidden fees. You see the price before we start — quoted via WhatsApp from your photos.",
    },
    {
      title: "Local & Reliable",
      description:
        "A local Birmingham business. We show up on time, every time, and take pride in our work.",
    },
    {
      title: "Friendly, Tidy Service",
      description:
        "Shoe covers, respectful of your home, no mess left behind. We treat your home as our own.",
    },
    {
      title: "Flexible Appointments",
      description:
        "Early mornings, evenings, weekends — we work around you, not the other way round.",
    },
  ],
};
